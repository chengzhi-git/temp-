...
<tr>
<form action="<%=request.getContextPath()%>/pm/bangdingcg2.do" method="post">
...
<td><input type="hidden" name="D2" value="${dList.get(1).DEPTID}"> ${dList.get(1).DEPTNAME}</td>
...
<c:forEach items="${jkList}" var="z">
<tr>
<form action="<%=request.getContextPath()%>/pm/jksc.do" method="post">
<td><input type="hidden" name="UID" value="${z.UID}">${z.UID}</td>
<td><input type="hidden" name="DEPTID"value="${z.DEPTID}">${z.DEPTID}</td>
<td><input type="hidden" name="UNAME"value="${z.UNAME}">${z.UNAME}</td>
<td><input type="hidden" name="UAGE"value="${z.UAGE}">${z.UAGE}</td>
