...
<tr>
<form action="<%=request.getContextPath()%>/pm/bangdingcg3.do" method="post">
...
<td><input type="hidden" name="D2" value="${dList.get(2).DEPTID}"> ${dList.get(2).DEPTNAME}</td>
...
<c:forEach items="${rkList}" var="z">
<tr>
<form action="<%=request.getContextPath()%>/pm/rksc.do" method="post">
<td><input type="hidden" name="UID" value="${z.UID}">${z.UID}</td>
<td><input type="hidden" name="DEPTID"value="${z.DEPTID}">${z.DEPTID}</td>
<td><input type="hidden" name="UNAME"value="${z.UNAME}">${z.UNAME}</td>
<td><input type="hidden" name="UAGE"value="${z.UAGE}">${z.UAGE}</td>
