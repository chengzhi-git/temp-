...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 已退回列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
      ...
      <c:forEach items="${planScList}"  var="planScList" varStatus="st">
        <tr>
         ...
         <!-- 入提交次数-->
          ...
          <!-- 退回时间-->
          <td><fmt:formatDate value="${planScList.PBTIME}" pattern="yyyy-MM-dd"/></td> 
