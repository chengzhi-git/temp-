...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 已提交列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
        ...
        <tr>
         ...
         <!-- 入提交次数-->
          <td>${planScList.PSUBMIT}</td>
           ...
           <!-- 入提交时间-->
          <td><fmt:formatDate value="${planScList.PLTIME}" pattern="yyyy-MM-dd"/></td>
